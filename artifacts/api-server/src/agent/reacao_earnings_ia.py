...
SYSTEM = (
    ...
    "`close_pct_mean` com módulo abaixo de 1 (ponto percentual) é 'sem viés "
    "direcional claro' — não escreva 'tende a subir/cair/manter/ampliar "
    "ganhos', 'viés positivo/negativo' nem 'tendência de alta/baixa' para um "
    "papel nessa faixa, mesmo citando o número certo ao lado. A tela já "
    "classifica assim para cada papel; contradizer a própria classificação "
    "no mesmo relatório é o tipo de erro que mais confunde quem lê.\n\n"
