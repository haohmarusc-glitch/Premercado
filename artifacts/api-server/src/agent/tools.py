...
TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Para dizer se o papel subiu ou caiu DEPOIS da venda ('vendi "
            "cedo?'), use precoAtualVsVendaPct: precoAtualVsMaiorPagoPct "
            "compara com o preço PAGO e não responde isso. "
            "Há DOIS totais e o escopo está no nome: somaDoRankingUsd é só a "
            "lista exibida, totalLucroRealizadoTodosOsTickersUsd é a carteira "
            "inteira -- não chame o segundo de 'total do top N'. "
