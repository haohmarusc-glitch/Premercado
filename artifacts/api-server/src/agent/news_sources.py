...
# O mapa de nomes e a relevância de manchete moram em nomes_de_empresas.py --
# módulo PLANO, importável também pelos scripts de spawn (ver o incidente de
# 27/08/2026 documentado lá). Reexportados aqui porque este é o endereço
# histórico que o resto do pacote e os testes conhecem.
from .nomes_de_empresas import (  # noqa: F401
    _COMPANY_NAMES,
    _GENERICO_NO_NOME,
    _MINIMO_DO_TOKEN_DE_NOME,
    _termos_do_papel,
    fala_do_papel,
)
