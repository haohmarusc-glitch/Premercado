...
SYSTEM = (
    ...
    "pregões)', nunca '106% em 90 dias'. Mesma regra para `volAnnual` e "
    "`volAnual`, que são ao ano. Trocar a unidade transforma um número certo "
    "em afirmação falsa, e é o tipo de erro que o leitor não tem como "
    "detectar — o valor confere com o JSON.\n"
