...
export const EntryExitStudyHistorySchema = zod.object({
  ...
  "entryPullbackPrice": zod.coerce.number().nullish().describe('Nivel de entrada projetado pela vol atual do papel (nao historico cru de minima)'),
  ...
  "newsSentimentReason": zod.string().nullish().describe('Uma frase justificando o rotulo.'),
  "createdAt": zod.string()
})
...
export const EntryExitStudyCalcResultSchema = zod.object({
  ...
  "avgLow6m": zod.coerce.number().nullish(),
  "minLow6m": zod.coerce.number().nullish(),
  "entryPullbackPrice": zod.coerce.number().nullish(),
  "volAnnual": zod.coerce.number().nullish(),
  "betaSector": zod.coerce.number().nullish(),
